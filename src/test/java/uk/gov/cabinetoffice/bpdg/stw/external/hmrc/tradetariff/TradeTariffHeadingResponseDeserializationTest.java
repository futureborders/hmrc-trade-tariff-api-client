...
class TradeTariffHeadingResponseDeserializationTest {
  ...
  void shouldGetData() {
    ...
    assertThat(expectedResponse.getData().getFormattedDescription())
        .isEqualTo("Cereal groats, meal and pellets");
  ...
  void shouldGetChapter() {
    ...
    assertThat(expectedResponse.getChapter().getDescription())
        .isEqualTo("Products of the milling industry; malt; starches; inulin; wheat gluten");
  }
  ...
  void shouldGetIncludedCommodities() {
    ...
    assertThat(expectedResponse.getIncludedCommodities().get(0).getDescription())
        .isEqualTo("Groats and meal");
    assertThat(expectedResponse.getIncludedCommodities().get(0).getGoodsNomenclatureItemId())
        .isEqualTo("1103110000");
    assertThat(expectedResponse.getIncludedCommodities().get(0).getLeaf())
        .isEqualTo(Optional.of(false));
    assertThat(expectedResponse.getIncludedCommodities().get(0).getSid())
        .isEqualTo(Optional.of(31959));
